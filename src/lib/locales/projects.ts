...
const vi = {
  ...
  hero: {
    ...
    subtitle:
      "Từ bệnh viện quốc phòng đến khách sạn 5 sao — mỗi công trình là một cam kết kỹ thuật dài hạn.",
  },
  filters: {
    type: "LOẠI",
    system: "HỆ",
...
const en: typeof vi = {
  ...
  hero: {
    ...
    subtitle:
      "From defense hospitals to 5-star hotels — every project is a long-term engineering commitment.",
  },
  filters: {
    type: "TYPE",
    system: "SYSTEM",
